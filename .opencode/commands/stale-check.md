...
1. **Check for stale pull requests:**
   ...
   - For each stale PR found, add a comment mentioning @tbrandenburg (the repository owner)

2. **Check for stale issues:**
   ...
   - For each stale issue found, add a comment mentioning @tbrandenburg (the repository owner)
...
@tbrandenburg - Could you please provide an update on this issue?
